...
from odin.bay.vi.autoencoder.variational_autoencoder import (LayerCreator,
                                                             _parse_layers)
from odin.networks import NetworkConfig, get_embedding
...
class auxiliaryVAE(conditionalM2VAE):
  ...
  def __init__(
      ...
      auxiliary: RVmeta = RVmeta(64,
                                 ...
                                 projection=True,
                                 name='auxiliary'),
      encoder_a: LayerCreator = NetworkConfig([512, 512],
                                              flatten_inputs=True,
                                              name='encoder_a'),
      decoder_a: LayerCreator = NetworkConfig([512, 512],
                                              flatten_inputs=True,
                                              name='decoder_a'),
      ...
      decoder: LayerCreator = NetworkConfig([512, 512],
                                            flatten_inputs=True,
                                            name='decoder'),
      axy_to_qz: LayerCreator = NetworkConfig([128, 128], name='axy_to_qz'),
      azy_to_px: LayerCreator = NetworkConfig([128, 128], name='azy_to_px'),
